...
namespace WebEdwinPractica.Controllers
{
    public class RegistrosController : Controller
    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Create([Bind("IdRegistro,Imagen,Documento,Nombre,Apellidos,FechaNac,Direccion,Celular,Genero,Deporte,Trabaja,Sueldo,Estado")] Registros registros)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        _context.Add(registros);
